            ...
            for(int y = 0; y < array.y; ++y) {
                for(int z = 0; z < array.z; ++z) {
                    ...
                    if(n % 6 < 3) {
                        ...
                        std::vector<axiom::vertex_element3d> elements = {
                            axiom::vertex_element3d{vec3(1.0f, 0.0f, 0.0f) * w / axiom::sqrt2 * side_length},
                            axiom::vertex_element3d{vec3(-1.0f, 0.0f, 0.0f) * w / axiom::sqrt2 * side_length},
                            axiom::vertex_element3d{vec3(0.0f, 1.0f, 0.0f) * w / axiom::sqrt2 * side_length},
                            axiom::vertex_element3d{vec3(0.0f, -1.0f, 0.0f) * w / axiom::sqrt2 * side_length},
                            axiom::vertex_element3d{vec3(0.0f, 0.0f, 1.0f) * w / axiom::sqrt2 * side_length},
                            axiom::vertex_element3d{vec3(0.0f, 0.0f, -1.0f) * w / axiom::sqrt2 * side_length},
                        };

                        vec3 color = axiom::hsv_color(rand() * -0.125f + 0.5f, 0.75f, 1.0f);
