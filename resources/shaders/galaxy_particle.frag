...
void main() {
    ...
    /*float r = ray_plane(vec3(0), dir, origin2, z_v);
    rel_ro = dir * r;
    ...
    vec3 t = ellipsoid_raycast(vec3(0), size.x * ratio, -origin2, -dir, up_matrix);
   //t.x = max(t.x, 0.0);
    ...
    } else discard;//frag_color = vec4(1.0, 0.0, 0.0, 1.0);
    //frag_color = vec4(1.0);
